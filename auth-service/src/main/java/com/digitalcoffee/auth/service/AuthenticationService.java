...
import com.digitalcoffee.auth.dto.request.AuthenticationRequest;
import com.digitalcoffee.auth.dto.request.IntrospectRequest;
import com.digitalcoffee.auth.dto.response.AuthenticationResponse;
import com.digitalcoffee.auth.dto.response.IntrospectResponse;
...
public class AuthenticationService {
    ...
    private String generateToken(UserRoot userRoot) {
        ...
        JWTClaimsSet jwtClaimsSet = new JWTClaimsSet.Builder()
                ...
                .claim("role", userRoot.getRoles().stream().map(UserRoleEntity::getRole).toList())
                .build();
